...
exports.index = (req, res) => {
  ...
  (err, results) => {
    res.render('index', { title: 'Little Library Home', error: err, data: results });
  });
};
    ...
    (err, results) => {
      ...
      for (const genre of results.genres) {
        for (const bookGenre of results.book.genre) {
          if (genre._id.toString() === bookGenre.id.toString()) {
            genre.checked = "true";
          }
        }
      }
...
exports.book_update_post = [
  ...
  (req, res, next) => {
    ...
    const book = new Book({
      ...
      _id: req.params.id, // to use the old id
    });
